 ...
 */
package me.parozzz.hopeclanv2.reflection;
...
public class NBTTag 
{
    ...
    */
    ...
    {
        compoundSetter.get(value.getClass()).invoke(compound.getNBTObject(), key, value);
    }
    ...
    */
    ...
    public static <T> T compoundGet(final NBTCompound compound, final String key, final Class<T> type) 
            throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
    {
        return (T)compoundGetter.get(type).invoke(compound.getNBTObject(), key);
    }
    ...
    */
    ...
    {  
        ...
        compoundSetBoolean=ReflectionUtils.getMethod(NBTTagCompoundClass, "setBoolean", String.class,boolean.class);
        ...
        compoundGetter.put(int.class, compoundGetInt);
        ...
        compoundSetter.put(int.class, compoundSetInt);
